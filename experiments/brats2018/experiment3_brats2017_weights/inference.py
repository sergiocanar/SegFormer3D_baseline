...
weights2_path = '/home/scanar/BCV_project/SegFormer3D_baseline/experiments/brats_2017/best_brats_2017_exp_dice_82.07/model_checkpoints/best_dice_checkpoint/pytorch_model.bin'
...
def dice_metric(y_true, y_pred):
    '''
    y_true: 3D numpy array
    y_pred: 3D numpy array
    '''
    

    dice_metric = DiceMetric(include_background=True, reduction="mean")
    avg_dice_score = dice_metric(y_pred, y_true)
